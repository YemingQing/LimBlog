<template>
  <el-card>
    <h1 class="me-author-name">Limerenxey</h1>
    <div class="me-author-description">
      <span><i class="el-icon-location-outline"></i> &nbsp;广东&广州</span>
      <span><i class="me-icon-job"></i> &nbsp;后端、记录、总结</span>
    </div>
...
<script>
  export default {
    ...
    data() {
      return {
        qq: {title: 'QQ', message: '872181635'},
        bilibili: {
          title: '哔哩哔哩',
          message: '<a target="_blank" href="https://space.bilibili.com/26556461">https://space.bilibili.com/26556461</a>'
        }
      }
    },
    methods: {
